/*
===============================================================================
Program Name    : Binary Tree - Search Operation (Element Not Present)
Program Number  : 009
File Name       : Tree_09.c
Description     : This program demonstrates the Search() operation of a
                  Binary Search Tree (BST) using C. It searches for an
                  element that is not present in the tree and reports the
                  result.
...
5. If smaller, move to the left subtree.
6. Continue until NULL is reached.
7. Return FALSE if the element is not found.
...
Program 009 demonstrates an unsuccessful Search() operation in a Binary
Search Tree using C. The program traverses the tree according to the BST
property and correctly reports when the specified element is not present.
